...
public class ViewConst {
    ...
    public static final int DEFAULT_SIDEBAR_SIZE = 100;
    public static final int DEFAULT_WINDOW_WIDTH = X_MAX * CELL_SIZE + DEFAULT_SIDEBAR_SIZE;
    ...
    public static final int SINGLE_GAME_PLAY_SCENE = 1;
    public static final int BATTLE_GAME_PLAY_SCENE = 2;
    ...
    public static final int SETTING_BATTLE_KEY_MENU_SCENE = 13;
